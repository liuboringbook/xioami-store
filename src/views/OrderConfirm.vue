<template>
  <div>
    ...
    <nav-bread><span>orderComfirm</span></nav-bread>
      ...
      <div class="item-list-wrap confirm-item-list-wrap">
        <div class="cart-item order-item">
          ...
          <ul class="cart-item-list">
            <li v-for="item in cartList" v-if="item.checked!=='0'">
...
<script>
  ...
  export default {
     ...
     methods: {
      ...
      payment(){
        axios.post("/users/payment",{addressId:this.addressId,orderTotal:this.orderTotal}).then((response)=>{
          let res =response.data;
