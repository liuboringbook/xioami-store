    ...
    <div class="checkout-addr">
      ...
      <div class="addr-list-wrap">
        <div class="addr-list">
          <ul>
            <li v-for="(item,index) in addressListFilter" :class="{'check':checkIndex == index}" @click="checkIndex=index">
              ...
              <div class="addr-opration addr-del" @click="showDelAddress(item.addressId)">
        ...
        <div class="shipping-addr-more">
          <a class="addr-more-btn up-down-btn" href="javascript:;" @click="expend" :class="limit.length===addressList.length?'':'open'">
            more
            <i class="i-up-down">
      ...
      <div class="next-btn-wrap">
        <a class="btn btn--m btn--red" @click="toComfirm">Next</a>
      </div>
    </div>
  </div>
</div>
